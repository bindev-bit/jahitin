      ...
      <main>
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://www.tailorsatelier.com/wp-content/uploads/2019/01/Tailors-Atelier-New-York.jpg')",
            }}
          >
            <span
              id="blackOverlay"
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    Membantu anda mendapatkan kenyamanan dalam berpakaian serta kualitas bahan yang 
                    kami sediakan merupakan dari bahan premium dan dapat menjaga ketahanan pakaian
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Tentukan ukuranmu</h6>
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600">
                      Gratis perbaikan pakaian apabila barang belum sesuai dengan keinginan anda
                      fitur ini aktif selama 6 bulan setelah pemesanan
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Pembayaran</h6>
                    <p className="mt-2 mb-4 text-gray-600">
              ...
              <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-blue-600">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    kain Indonesia bergambar yang pembuatannya secara khusus dengan menuliskan atau menerakan malam pada kain itu, kemudian pengolahannya diproses dengan cara tertentu yang memiliki kekhasan.
                    </p>
                  </blockquote>
                </div>
              </div>
            ...
            <div className="items-center flex flex-wrap">
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  ...
                  <h3 className="text-3xl font-semibold">Pemilihan Batik</h3>
                  <p className="mt-4 text-lg leading-relaxed text-gray-600">
                    Batik menjadi satu icon dari website ini 
                    karena penerapannya dapat meningkatkan beberapa bagian di indonesia, seperti
                  </p>
